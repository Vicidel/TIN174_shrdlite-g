...
export var grammar : NearleyGrammar = {
    ...
    {"name": "entity", "symbols": ["quantifierSG", "simpleObjectSG"], "postprocess": (d) => new Entity(d[0], d[1])},
    {"name": "entity", "symbols": ["quantifierSG", "relativeObjectSG"], "postprocess": (d) => new Entity(d[0], d[1])},
    {"name": "entity", "symbols": ["quantifierPL", "simpleObjectPL"], "postprocess": (d) => new Entity(d[0], d[1])},
    {"name": "entity", "symbols": ["quantifierPL", "relativeObjectPL"], "postprocess": (d) => new Entity(d[0], d[1])},
    {"name": "relativeObjectSG$ebnf$1", "symbols": ["that_is"], "postprocess": id},
    {"name": "relativeObjectSG$ebnf$1", "symbols": [], "postprocess": (d) => null},
    {"name": "relativeObjectSG", "symbols": ["simpleObjectSG", "relativeObjectSG$ebnf$1", "location"], "postprocess": (d) => new RelativeObject(d[0], d[2])},
    {"name": "relativeObjectPL$ebnf$1", "symbols": ["that_are"], "postprocess": id},
    {"name": "relativeObjectPL$ebnf$1", "symbols": [], "postprocess": (d) => null},
    {"name": "relativeObjectPL", "symbols": ["simpleObjectPL", "relativeObjectPL$ebnf$1", "location"], "postprocess": (d) => new RelativeObject(d[0], d[2])},
    {"name": "simpleObjectSG$ebnf$1", "symbols": ["size"], "postprocess": id},
    {"name": "simpleObjectSG$ebnf$1", "symbols": [], "postprocess": (d) => null},
    {"name": "simpleObjectSG$ebnf$2", "symbols": ["color"], "postprocess": id},
    {"name": "simpleObjectSG$ebnf$2", "symbols": [], "postprocess": (d) => null},
    {"name": "simpleObjectSG", "symbols": ["simpleObjectSG$ebnf$1", "simpleObjectSG$ebnf$2", "formSG"], "postprocess": (d) => new SimpleObject(d[0], d[1], d[2])},
    {"name": "simpleObjectPL$ebnf$1", "symbols": ["size"], "postprocess": id},
    {"name": "simpleObjectPL$ebnf$1", "symbols": [], "postprocess": (d) => null},
    {"name": "simpleObjectPL$ebnf$2", "symbols": ["color"], "postprocess": id},
    {"name": "simpleObjectPL$ebnf$2", "symbols": [], "postprocess": (d) => null},
    {"name": "simpleObjectPL", "symbols": ["simpleObjectPL$ebnf$1", "simpleObjectPL$ebnf$2", "formPL"], "postprocess": (d) => new SimpleObject(d[0], d[1], d[2])},
    ...
    {"name": "relation$subexpression$8$string$1", "symbols": [{"literal":"b"}, {"literal":"e"}, {"literal":"h"}, {"literal":"i"}, {"literal":"n"}, {"literal":"d"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$8", "symbols": ["relation$subexpression$8$string$1"]},
    {"name": "relation$subexpression$8$string$2", "symbols": [{"literal":"i"}, {"literal":"n"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$8$string$3", "symbols": [{"literal":"b"}, {"literal":"a"}, {"literal":"c"}, {"literal":"k"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$8$string$4", "symbols": [{"literal":"o"}, {"literal":"f"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "relation$subexpression$8$string$5", "symbols": [{"literal":"t"}, {"literal":"o"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$8$string$6", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$8$string$7", "symbols": [{"literal":"b"}, {"literal":"a"}, {"literal":"c"}, {"literal":"k"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$8$string$8", "symbols": [{"literal":"o"}, {"literal":"f"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "relation", "symbols": ["relation$subexpression$8"], "postprocess": (d) => "behind"},
    {"name": "relation$subexpression$9$string$1", "symbols": [{"literal":"b"}, {"literal":"e"}, {"literal":"f"}, {"literal":"o"}, {"literal":"r"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$9", "symbols": ["relation$subexpression$9$string$1"]},
    {"name": "relation$subexpression$9$string$2", "symbols": [{"literal":"i"}, {"literal":"n"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$9$string$3", "symbols": [{"literal":"f"}, {"literal":"r"}, {"literal":"o"}, {"literal":"n"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$9$string$4", "symbols": [{"literal":"o"}, {"literal":"f"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "relation$subexpression$9$string$5", "symbols": [{"literal":"t"}, {"literal":"o"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$9$string$6", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$9$string$7", "symbols": [{"literal":"f"}, {"literal":"r"}, {"literal":"o"}, {"literal":"n"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "relation$subexpression$9$string$8", "symbols": [{"literal":"o"}, {"literal":"f"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "relation", "symbols": ["relation$subexpression$9"], "postprocess": (d) => "before"},
    ...
    {"name": "form$string$6", "symbols": [{"literal":"c"}, {"literal":"u"}, {"literal":"p"}], "postprocess": (d) => d.join('')},
    {"name": "form", "symbols": ["form$string$6"], "postprocess": (d) => "cup"},
    {"name": "form$string$7", "symbols": [{"literal":"f"}, {"literal":"l"}, {"literal":"o"}, {"literal":"o"}, {"literal":"r"}], "postprocess": (d) => d.join('')},
    {"name": "form", "symbols": ["form$string$7"], "postprocess": (d) => "floor"},
